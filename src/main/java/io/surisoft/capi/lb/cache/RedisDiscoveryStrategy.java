...
public class RedisDiscoveryStrategy  { /*extends AbstractDiscoveryStrategy {
    ...
    public RedisDiscoveryStrategy(DiscoveryNode discoveryNode, ILogger logger, Map<String, Comparable> properties, ApiRepository apiRepository) {
    ...
    public Iterable<DiscoveryNode> discoverNodes() {
        ...
        Iterable<CapiNode> nodeList = apiRepository.findAll();
