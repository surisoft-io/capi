...
public class RunningApiManager {
    ...
    public RunningApiManager(HazelcastInstance hazelcastInstance, RunningApiListener runningApiListener) {
        this.hazelcastInstance = hazelcastInstance;
        this.runningApiListener = runningApiListener;
    }
    ...
    public void runApi(String routeId, Api api) {
        if(getRunningApiByRouteId(routeId) == null) {
            log.info("Ad^``ding API definition to run time cache.");
            RunningApi runningApi = new RunningApi();
            runningApi.setApiId(api.getId());
            runningApi.setContext(api.getContext());
            runningApi.setName(api.getName());
