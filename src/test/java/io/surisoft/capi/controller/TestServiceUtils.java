...
class TestServiceUtils {
    ...
    @Test
    void testIfValidOpenApiIsEnabled() {
                ...
                components:
                  ...
                  securitySchemes:
                    ...
                    api_key:
                      ...
                      name: api_key
                      in: header""";
        wireMockServer.stubFor(get(urlEqualTo("/api")).willReturn(aResponse().withBody(openApiDefinition)));
    ...
    @Test
    void testIfInvalidOpenApiIsEnabled() {
        WireMockRule wireMockServer = new WireMockRule(wireMockConfig().dynamicPort());
        wireMockServer.start();
        wireMockServer.stubFor(get(urlEqualTo("/api")).willReturn(aResponse().withBody("openApiDefinition")));
